...
const checkIcon = (
  <svg
    ...
    viewBox="-10 -10 48 48"
    className="w-8 h-8 border  rounded bg-white shadow-lg hover:bg-slate-200 hover:cursor-pointer ">
    <path
      fillRule="evenodd"
...
const closeIcon = (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="-12 -12  48 48"
    className="w-8 h-8  border hover:bg-slate-200 bg-white rounded shadow-lg m-2 hover:cursor-pointer ">
    <path
      fillRule="evenodd"
