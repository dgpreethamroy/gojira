...
const menu_icon_dots = (
  <svg className="TaskMenu" width="28" height="28" viewBox="0 0 24 24" role="presentation">
...
const checkIcon = (
  <svg
    ...
    viewBox="-10 -10 48 48"
    className="w-8 h-8 border checkIcon border-slate-200 rounded bg-white shadow-lg hover:bg-slate-200 hover:cursor-pointer ">
    <path
      fillRule="evenodd"
...
const closeIcon = (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="-12 -12  48 48"
    className="w-8 h-8  border closeIcon hover:bg-slate-200 bg-white rounded shadow-lg m-2 hover:cursor-pointer ">
    <path
      fillRule="evenodd"
...
const Calendar_Filter_Data = [
  {
    label: (
      <span>
        <svg role="presentation" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
          <path
...
const Leftarrow_Icon = (
  <svg width="24" height="24" viewBox="0 0 24 24" role="presentation">
    <path
      fill="currentColor"
      fill-rule="evenodd"
      d="M9.005 10.995l4.593-4.593a.99.99 0 111.4 1.4l-3.9 3.9 3.9 3.9a.99.99 0 01-1.4 1.4L9.005 12.41a1 1 0 010-1.414z"></path>
  </svg>
);
const Rightarrow_Icon = (
  <svg width="24" height="24" viewBox="0 0 24 24" role="presentation">
    <path
      fill="currentColor"
      fill-rule="evenodd"
      d="M14.995 10.995a1 1 0 010 1.414l-4.593 4.593a.99.99 0 01-1.4-1.4l3.9-3.9-3.9-3.9a.99.99 0 011.4-1.4l4.593 4.593z"></path>
  </svg>
);
const checkwithCircle_Icon = (
  <svg role="presentation" fill="none" viewBox="0 0 24 24" width="24" height="24">
    <path
      d="M12 20a8 8 0 100-16.001A8 8 0 0012 20zm0 2C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10-4.477 10-10 10z"
      fill="currentColor"></path>
    <path
...
const Profile_Icon = (
  <svg role="presentation" width="24" height="24" fill="none" viewBox="0 0 24 24">
    <path
      d="M12 3a9 9 0 014.78 16.627c-.154.19-.375.323-.628.361A8.978 8.978 0 0112 21a8.961 8.961 0 01-4.151-1.013.993.993 0 01-.628-.36A9 9 0 0112 3zm1 13h-2l-.15.006a2 2 0 00-1.844 1.837L9 18v.326c.91.432 1.927.674 3 .674a6.972 6.972 0 003-.674V18l-.005-.15a2 2 0 00-1.838-1.844L13 16zM12 5a7 7 0 00-4.88 12.02 4.004 4.004 0 013.673-3.015L11 14h2l.2.005a4.002 4.002 0 013.679 3.013A7 7 0 0012 5zm0 2a3 3 0 110 6 3 3 0 010-6zm0 2a1 1 0 100 2 1 1 0 000-2z"
      fill="currentColor"></path>
  </svg>
...
const TestData = {
  tasks: {
    ...
    "task-32": {
      ...
      description: "table component re-renders upon Hover of labels....This is too much",
      issuetype: "Bug",
      assignee: "65c12653308c67170f17e2e0",
...
const upArrow = (
  <svg width="24" height="24" viewBox="0 0 24 24" role="presentation" className=" rotate-180">
    <path
      d="M11 6v9.586l-3.793-3.793a.999.999 0 00-1.414 0c-.39.39-.39 1.024 0 1.415l5.5 5.499A.993.993 0 0012 19a.993.993 0 00.707-.293l5.5-5.499a1 1 0 10-1.414-1.415L13 15.586V6a1 1 0 00-2 0z"
      fill="currentColor"></path>
  </svg>
